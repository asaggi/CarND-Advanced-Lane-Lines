...
#Load calibrationration
calibrationration=dict()
with open('output_images/calibrate.json', 'r') as f:
    calibration=json.load(f)
calibration['matrix']=np.array(calibration['matrix'])
...
class LaneDetector:
    ...
    def undistort(self,img):
        ...
        Undistort image
        '''
        return cv2.undistort(img,calibration['matrix'], calibration['dist'], None,None)
